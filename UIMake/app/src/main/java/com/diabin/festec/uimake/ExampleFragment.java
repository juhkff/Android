...
import com.diabin.festec.uimake.sample.Example;
...
public class ExampleFragment extends Fragment {
     ...
     */
    public ExampleFragment(MainFragment mainFragment) {
        this.parentFragment=mainFragment;
    }

    // TODO: Customize parameter initialization
    /*@SuppressWarnings("unused")
    public static ExampleFragment newInstance(int columnCount) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new MyExampleRecyclerViewAdapter(getActivity(),generateDatas(),parentFragment));
        }
        return view;
    }
